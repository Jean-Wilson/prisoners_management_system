...
<div class="mt-3">
	<div class="">
			...
			<div class="text-end mx-5 mb-3">
						 <a href="staff.php"><button class="btn btn-success px-5 fw-bold rounded">Add Staff</button></a>
			</div>
		</div>
           ...
           <tr>
           	...
           	<td><?php echo $row['names']?></td>
           	 ...
           	 <td>
           	 	...
           	 	<a href="stupdate.php?staff_id=<?php echo $row['staff_id']?>"><button class="btn btn-primary">update</button></a>
           	 <a href="stdelete.php?staff_id=<?php echo $row['staff_id']?>"><button class="btn btn-danger">delete</button></a>
